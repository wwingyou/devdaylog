    ...
    <Layout>
      <div className="post">
        <div className="post_meta">
          <p className="post_date">2024/01/16(화) 12:24</p>
          <h4 className="post_heading">ssh-keygen 똑똑하게 사용하기</h4>
        ...
        <main className="post_content">
          ...
          <pre><code className="language-bash">ssh-keygen -t rsa -b 4096
          </code></pre>
